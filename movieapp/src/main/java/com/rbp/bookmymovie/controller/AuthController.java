...
@CrossOrigin(origins = {"http://localhost:3000", "http://localhost:3001", "http://localhost:3002", "http://bmmfrontendbucket.s3-website-us-east-1.amazonaws.com/", "http://bmmfrontendforecs.s3-website-us-east-1.amazonaws.com"})
@RestController
